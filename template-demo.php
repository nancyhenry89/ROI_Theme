        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="about_cont">
                    ...
                    <button type="button" class="btn btn-primary"><?php echo get_post_meta( get_the_ID(), 'btn1', true ); ?></button>
                
                    </div>
                    <div class="about_sec two">
                        <?php echo get_post_meta( get_the_ID(), 'about2_box', true ); ?>
                        <button type="button" class="btn btn-primary"><?php echo get_post_meta( get_the_ID(), 'btn2', true ); ?></button>

                    </div>
                    <div class="about_sec three">
                    <?php echo get_post_meta( get_the_ID(), 'about3_box', true ); ?>
                    <button type="button" class="btn btn-primary"><?php echo get_post_meta( get_the_ID(), 'btn3', true ); ?></button>
